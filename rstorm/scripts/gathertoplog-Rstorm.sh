...
file_serverinfo=/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/scripts/PrivateIPs.txt

#file_outputcommands=usefulcommands.txt

#file_pem=/home/ubuntu/anshu.pem

expNum=22113003301511180
...
#/usr/local/bin/sshpass -p dream@119  scp -o "ProxyCommand /usr/local/bin/corkscrew proxy.iisc.ernet.in 3128  $i 22"  anshu@$i:/home/anshu/toplogFinalSC/toplogFloatPI/cpuRstorm-$expNum*  $path_dest
...
/usr/local/bin/sshpass -p dream@119  scp   anshu@$i:/home/anshu/toplogFinalSC/toplogBlockWindowLog/*-$expNum*  $path_dest
