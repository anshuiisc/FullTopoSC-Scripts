...
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/DataAnlytics1/scheduler/parsing/logwithstringxml/cpu/clear-cpu*.txt"
# use for removing 100% before commenting below line ...
# sed   -i .bak  '/100/d'  clear-cpuFloat-251*
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/DataAnlytics1/scheduler/parsing/logwithstringxml/cpu/cpu*.txt"

expID="*-60*"

outDirForBoxplot="/Users/anshushukla/PycharmProjects/AzureBlob/log1/plot/"
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/AzureBlob/log1/cpu/clear-cpu*"+expID+".txt"
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/AzureBlob/log1/cpu/cpu*"+expID+".txt"
