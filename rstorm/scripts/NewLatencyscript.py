...
# cmd="ls -1 "+"/Users/anshushukla/PycharmProjects/DataAnlytics1/scheduler/parsing/logwithstringxml/log/spout*"
...
outDir="/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/dat"
cmd="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/log/spout*-22213003301511250*"
...
## old tarun script for Mean / Max / Min for fork merge case

    # meanDF = dgrouped.mean()
    # maxDF = dgrouped.max()
    # minDF = dgrouped.min()
    #
    # # fileIdentifier = spoutFileName.split('/')[-1][6:-4]
    #
    # meanDF.to_csv(outDir + '/L-AVG-' + fileIdentifier + '.dat', header=False,
    #               columns=['timestamp_x', 'timestamp_y', 'latency'])
    # maxDF.to_csv(outDir + '/L-MAX-' + fileIdentifier + '.dat', header=False,
    #              columns=['timestamp_x', 'timestamp_y', 'latency'])
    # minDF.to_csv(outDir + '/L-MIN-' + fileIdentifier + '.dat', header=False,
    #              columns=['timestamp_x', 'timestamp_y', 'latency'])