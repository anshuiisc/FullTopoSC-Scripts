...
expID="*-186*"
folderID=186480480521330

# expID="*-172*"
# folderID=17216464211190

outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/cpu/"+str(folderID)+"/"
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/cpu/"+str(folderID)+"/*.net/clear-cpu*"+expID+".txt"
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/cpu/"+str(folderID)+"/*.net/cpu*"+expID+".txt"
...
listclearedfilesMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/cpu/"+str(folderID)+"/*.net/clear-Mem-*"+expID+".txt"
listbeforegrepMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/cpu/"+ str(folderID) +"/*.net/cpu*"+expID+".txt"
...
print "check for length",len(p),len(q)
# exit()
########
...
# savefig(outDirForBoxplot+'VMwiseCPUMEMBoxPlotDefault-'+str(folderID)+'.png', bbox_inches='tight')

savefig(outDirForBoxplot+'BoxPlotLatency-MaxAlloc-RstormMapping.pdf', bbox_inches='tight')

# savefig(outDirForBoxplot+'BoxPlotLatency-LinearAlloc-RstormMapping.pdf', bbox_inches='tight')
