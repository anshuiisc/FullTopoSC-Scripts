def orderinglogicForThreadFromEXPID(i):
    ...
    print expID,divmod(int(expID),1000)

    return divmod(int(expID),1000)[1]
...
outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/plot/"
expID="-186480480521*"
print expID
cmd="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/dat/L-*"+expID+"*.dat"

# ## for  plotting Expid adjustment in case of linear scaling
# outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/plot/"
# expID="-*"
# print expID
# cmd="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/rstorm/dat/finallog/L-*"+expID+"*.dat"
...
# fig.savefig(outDirForBoxplot+"BoxPlotLatency-LinearAlloc-RstormMapping.pdf", bbox_inches='tight')
fig.savefig(outDirForBoxplot+"BoxPlotLatency-MaxAlloc-RstormMapping.pdf", bbox_inches='tight')