...
outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/defaultscheduler/cpu/"+str(folderID)+"/"
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/defaultscheduler/cpu/"+str(folderID)+"/*.net/clear-cpu*"+expID+".txt"
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/defaultscheduler/cpu/"+str(folderID)+"/*.net/cpu*"+expID+".txt"
...
listclearedfilesMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/defaultscheduler/cpu/"+str(folderID)+"/*.net/clear-Mem-*"+expID+".txt"
listbeforegrepMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/defaultscheduler/cpu/"+ str(folderID) +"/*.net/cpu*"+expID+".txt"
...
savefig(outDirForBoxplot+'BoxPlotLatency-LinearAlloc-DefaultMapping.png', bbox_inches='tight')
