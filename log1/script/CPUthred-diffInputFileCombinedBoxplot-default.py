...
expID="*-31*"
folderID=31133030015111180

# expID="*-163*"
# folderID=1631480480611210

outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/log1/cpu/"+str(folderID)+"/"
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/log1/cpu/"+str(folderID)+"/*.net/clear-cpu*"+expID+".txt"
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/log1/cpu/"+str(folderID)+"/*.net/cpu*"+expID+".txt"
...
listclearedfilesMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/log1/cpu/"+str(folderID)+"/*.net/clear-Mem-*"+expID+".txt"
listbeforegrepMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/log1/cpu/"+ str(folderID) +"/*.net/cpu*"+expID+".txt"
