...
dest="/Users/anshushukla/PycharmProjects/FullTopoSC/log1/plot/"



for i in `ls $internalFiles/T-spout*-112*.dat`
do
...
python  /Users/anshushukla/PycharmProjects/FullTopoSC/log1/script/plotThroughput.py    $i $dest
#python  /Users/anshushukla/PycharmProjects/FullTopoSC/log1/script/plotThroughput-scatter.py    $i   $dest
