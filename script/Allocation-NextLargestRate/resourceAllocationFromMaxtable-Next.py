...
def getThreadsFromrate(rateNeeded,boltname):
    ...
    for r in eval(boltname+"_rateTothreadMap_rev"):
        ...
        if(rateNeeded==r):
            # print "rateNeeded1-",rateNeeded,"threadNeeded1-",blob_rateTothreadMap[r]
            print eval(boltname+'_rateTothreadMap[r]')
            return eval(boltname+'_rateTothreadMap[r]')



        elif(rateNeeded<r and rateNeeded > min(eval(boltname+'_rateTothreadMap'))):
            ...
            print  "rateNeeded3-", rateNeeded,"prev_r_Val",prev_r_Val,"threadNeeded3-",blob_rateTothreadMap[prev_r_Val]
            print eval(boltname + '_rateTothreadMap[prev_r_Val]')
            return eval(boltname+'_rateTothreadMap[prev_r_Val]')
...
# commonrate=280
boltname_inputRateNeedMap={'blob':commonrate ,'table':commonrate,'xmlparse':commonrate,'floatpi':commonrate,'batchedWrite':commonrate}
