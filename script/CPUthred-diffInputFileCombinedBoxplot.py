...
outDirForBoxplot="/Users/anshushukla/PycharmProjects/FullTopoSC/script/test/"
listclearedfiles="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/script/test/*.net/clear-cpu*"+expID+".txt"
listbeforegrep="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/script/test/*.net/cpu*"+expID+".txt"
...
listclearedfilesMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/script/test/*.net/clear-Mem-*"+expID+".txt"
listbeforegrepMem="ls -1 "+"/Users/anshushukla/PycharmProjects/FullTopoSC/script/test/*.net/cpu*"+expID+".txt"
...
legend((hB, hR), ('CPU', 'Memory'),loc='upper center', bbox_to_anchor=(0.5, 1.05),
