...
dest="/Users/anshushukla/PycharmProjects/AzureBlob/log1/plot/"



for i in `ls $internalFiles/T-spout*272*.dat`
do
...
#python  /Users/anshushukla/PycharmProjects/AzureBlob/script/plotThroughput.py    $i $dest
python  /Users/anshushukla/PycharmProjects/AzureBlob/script/plotThroughput-scatter.py    $i   $dest
